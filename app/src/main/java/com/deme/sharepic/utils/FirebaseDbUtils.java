...
import com.deme.sharepic.models.SuggestSticker;
import com.deme.sharepic.models.UseSticker;
...
public class FirebaseDbUtils {
    ...
    public FirebaseDbUtils(Context context) {
        ...
        prefs = context.getSharedPreferences("SharePic", Context.MODE_PRIVATE);
        uid = prefs.getString(KEY_UID, null);
        db = new SharePicDBHandler(context);
    }
    ...
    public void saveUseStickersToServer(ArrayList<String> words, ArrayList<String> stickers, String userId) {
        ...
        DatabaseReference wordRef = myRef.child("useWords");
