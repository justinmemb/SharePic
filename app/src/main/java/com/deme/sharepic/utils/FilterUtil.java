...
public class FilterUtil {
    ...
    public static GPUImageFilter createFilterForType(final Context context, final FilterType type) {
        switch (type) {
            ...
            case SATURATION:
                return new GPUImageSaturationFilter(1.2f);
            case EXPOSURE:
                return new GPUImageExposureFilter(0.5f);
            case HIGHLIGHT_SHADOW:
                return new GPUImageHighlightShadowFilter(0.0f, 2.0f);
            case MONOCHROME:
                return new GPUImageMonochromeFilter(1.0f, new float[]{0.6f, 0.45f, 0.3f, 1.0f});
            case OPACITY:
                return new GPUImageOpacityFilter(1.0f);
            case RGB:
                return new GPUImageRGBFilter(1.3f, 1.1f, 0.9f);
            case WHITE_BALANCE:
                return new GPUImageWhiteBalanceFilter(5000.0f, 1.0f);
            case VIGNETTE:
            ...
            case HAZE:
                return new GPUImageHazeFilter(-0.1f,0.1f);
            case LAPLACIAN:
            ...
            case LEVELS_FILTER_MIN:
                ...
                return levelsFilter;
            case HALFTONE:
                return new GPUImageHalftoneFilter(0.5f);
    ...
    private static GPUImageFilter createBlendFilter(Context context, Class<? extends GPUImageTwoInputFilter> filterClass) {
        try {
            ...
            filter.setBitmap(BitmapFactory.decodeResource(context.getResources(), R.drawable.blend_lightblu));
            return filter;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
