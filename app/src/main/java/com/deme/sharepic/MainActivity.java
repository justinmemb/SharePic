...
import com.deme.sharepic.adapters.AlbumAdapter;
import com.deme.sharepic.adapters.GalleryAdapter;
import com.deme.sharepic.models.Album;
import com.deme.sharepic.models.AlbumData;
import com.deme.sharepic.utils.AlbumLoader;
import com.deme.sharepic.utils.AppUtils;
import com.deme.sharepic.utils.FirebaseDbUtils;
...
import static com.deme.sharepic.utils.Constants.CAMERA_WITH_DATA;
import static com.deme.sharepic.utils.Constants.FACEBOOK_URL;
...
import static com.deme.sharepic.utils.Constants.MY_PERMISSIONS_REQUEST_CAMERA;
import static com.deme.sharepic.utils.Constants.MY_PERMISSIONS_REQUEST_READ_EXTERNAL_STORAGE;
import static com.deme.sharepic.utils.Constants.MY_PERMISSIONS_REQUEST_WRITE_EXTERNAL_STORAGE;
...
//                layoutParams.height = width*3/4;//unpaid version
    ...
    private void initAllValiables() {
        hud = new KProgressHUD(MainActivity.this).setStyle(KProgressHUD.Style.SPIN_INDETERMINATE)
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                SharedPreferences.Editor pref = getSharedPreferences("SharePic", Context.MODE_PRIVATE).edit();
                ...
                if (user != null) {
                    ...
                    SharedPreferences pre = getSharedPreferences("SharePic", Context.MODE_PRIVATE);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_email:
                ...
                emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Check this app: SharePic");
                emailIntent.putExtra(Intent.EXTRA_INITIAL_INTENTS, "http://allyouneedapp.com");
                emailIntent.putExtra(Intent.EXTRA_TEXT, "Hi, \n \n I love SharePic app. It’s wonderful to share wonderful moment with friend and can put a meaningful sticker. Here is the link: http://allyouneedapp.com");

                /* Send it off to the Activity-Chooser */
                startActivity(Intent.createChooser(emailIntent, "Send mail..."));
                break;
            case R.id.btn_follow_us:
                String uri = "http://instagram.com/user/username=SharePicapp";
...
//                launchMarket();
            ...
            case R.id.btn_suggest_sticker_main:
                ...
                SharedPreferences prefs = getSharedPreferences("SharePic", Context.MODE_PRIVATE);
    ...
    public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
        switch (parent.getId()) {
            case R.id.gridView_album:
                if (galleryData.get(position).getBitmap()!= null) {
                    Intent intent = new Intent(this, CropActivity.class);
