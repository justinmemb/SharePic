...
public class CropOverlayView extends View
{
	...
	public boolean onTouchEvent(MotionEvent event)
	{
		...
		switch (event.getAction())
		{
			...
			case MotionEvent.ACTION_MOVE :
				...
				return true;
			case MotionEvent.ACTION_OUTSIDE: // added by Dima
	...
	private void onActionUp()
	{
		...
		if (mPressedHandle == null){
			mTouchOutSideListener.onTouchOutSide(this);
			return;
		}
	...
	public void setmTouchOutSideListener(TouchOutSideListener listener){
		this.mTouchOutSideListener = listener;
	}
