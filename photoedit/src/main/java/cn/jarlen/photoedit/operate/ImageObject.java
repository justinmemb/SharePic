...
public class ImageObject
{
	...
	/**
	 * Construction method
	 * @param srcBm Source image
	 * @param rotateBm Rotate the image
	 * @param deleteBm	Delete the picture
	 */
	public ImageObject(Bitmap srcBm, Bitmap rotateBm, Bitmap deleteBm)
	{
		...
		paint.setAntiAlias(true);// Remove the edge teeth
		paint.setStrokeWidth(2);// Set the line width
	}
	/**
	 * Construction method
	 * @param srcBm	Source image
	 * @param x The picture initializes the x coordinate
	 * @param y	The picture initializes the y coordinate
	 * @param rotateBm	Rotate the image
	 * @param deleteBm Delete the picture
	 */
	...
	int first = 0;// To determine whether the first time
	...
	/**
	 * Gets the width of the display picture
	 * @return
	 */
	public int getWidth()
	{
	...
	/**
	 * Gets the height of the display picture
	 * @return
	 */
	...
	/**
	 * Gets the point at the top-left corner of the rectangle
	 * 
	 * @return
	 */
	...
	/**
	 * Gets the point in the canvas in the upper-left corner of the rectangle
	 * 
	 * @return
	 */
	...
	/**
	 * Gets the point in the canvas in the upper-right corner of the rectangle
	 * 
	 * @return
	 */
	...
	/**
	 *Gets the point in the canvas in the lower-right corner of the rectangle
	 * 
	 * @return
	 */
	...
	/**
	 * Gets the point in the canvas in the lower-left corner of the rectangle
	 * 
	 * @return
	 */
	...
	/**
	 *Gets the zoom and rotation points
	 * 
	 * @return
	 */
	...
	/**
	 *Determine whether the click on the corner button
	 * 
	 * @param x
	 *            The abscissa of the contact
	 * @param y
	 *            The ordinate of the contact
	 * @param type
	 *            Four corners of the location
	 * @return
	 */
	...
	/**
	 * Calculates the coordinates of the center point
	 */
	...
	/**
	 * The vertex coordinates are obtained according to the rotation angle
	 * 
	 * @param rotation
	 * @return
	 */
