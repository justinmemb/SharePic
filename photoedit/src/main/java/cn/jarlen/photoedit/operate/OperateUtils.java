...
/**
 * Add a text picture tool class
 */
public class OperateUtils
{
	private Activity activity;
	private int screenWidth;// Mobile phone screen width (pixels)
	private int screenHeight;// Mobile phone screen high (pixels)
	...
	/**
	 * According to the path to obtain pictures and compression, to adapt to view
	 *
	 * @param filePath
	 * Image path
	 * @param contentView
	 *		Adapted view
	 * @return Bitmap Compressed images
	 */
	...
	/**
	 * Compresses the picture and fits the view
	 *
	 * @param bitmap
	 * Compress pictures
	 * @param contentView
	 ...
	 * @param text
	 * Added text
	 * @return TextObject Returns the font image object
	 */
	 ...
	 * @param quadrant
	 *            Area where the picture is to be displayed (1, upper left, 2, upper right, 3, lower left, 4, lower right, 5, center)
	 * @param x
	 *            From the boundary x coordinate
	 * @param y
	 *            From the boundary y coordinate
	 * @return
	 */
