	...
	public Bitmap handleImage(int type)
	{
		...
		switch (type)
		{
			...
			case Enhance_Contrast :
				...
				/* In the case of constant brightness, improve the contrast must reduce the brightness */
